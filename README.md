...
<body class="text-white flex items-center justify-center p-4">
    ...
    <script>
        ...
        const BUG_TYPES = [
            ...
            "GPS_GLITCH", "MIC_MUTE", "CAM_FREEZE", "STORAGE_FULL", "WIFI_DROP", "BLUETOOTH_LAG", 
            "UI_SHAKE", "FONT_MESS", "KEYBOARD_STUCK"
        ];
        ...
        function loadDashboard(acc) {
            ...
            const bugLimit = isPrem ? 3000 : 100;
            document.getElementById('bug-count').textContent = bugLimit;
            ...
            if (isPrem) {
                ...
                setTimeout(() => closeBtn.classList.remove('hidden'), 8000);
            }
        }
